...
import com.cn.train.business.feign.MemberFeign;
import com.cn.train.business.mapper.ConfirmOrderMapper;
import com.cn.train.business.mapper.DailyTrainSeatMapper;
import com.cn.train.business.mapper.DailyTrainTicketMapperCust;
import com.cn.train.business.service.IAfterConfirmOrderService;
...
public class AfterConfirmOrderServiceImpl implements IAfterConfirmOrderService {
    ...
    public void afterDoConfirm(DailyTrainTicket dailyTrainTicket, List<DailyTrainSeat> finalSeatList, List<ConfirmOrderTicketReq> tickets, ConfirmOrder confirmOrder) {
        ...
        for (int j = 0; j < finalSeatList.size(); j++) {
            ...
            RestResult<Object> result = memberFeign.save(memberTicketReq);
